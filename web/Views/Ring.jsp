...
<head>
    ...
    <link href="Template/css/3-col-portfolio.css" rel="stylesheet">
...
<nav class="navbar navbar-fixed-top navbar-inverse" role="navigation">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="TrangchuForward" style="font-size: 30px; color: chartreuse;"> QD FOOD</a>
        </div>
    ...
    <div class="nav-search" id="nav-search" style="margin-left: 1150px;">
        <form name="myform" action="HomeController" method="post">
            <input  type="text" placeholder="Nhập tên món ăn..." style="border-radius: 10px;height: 40px;width: 230px;border: none" name="namefood"/>
