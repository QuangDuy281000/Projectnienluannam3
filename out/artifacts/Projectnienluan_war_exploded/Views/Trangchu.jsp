...
<header>
    ...
    <nav id="topNav" class="navbar navbar-default main-menu">
        <div class="container">
            ...
            <p style="font-size: 30px; color: chartreuse;">QD FOOD</p>
            <div class="collapse navbar-toggleable-sm" id="collapsingNavbar">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href="HomeForward?pageid=1">MENU</a>
                    </li>
                </ul>
            </div>
        </div>
...
<%--    <div class="sp-slides">--%>
        ...
        <div class="sp-slide main-slides">
            ...
            <img class="sp-image" src="Template/images/slider/slider-img-1.jpg" alt="Slider 1" />
            ...
            <p class="sp-layer" data-position="center" data-vertical="15%" data-show-delay="2000" data-hide-delay="200" data-show-transition="left" data-hide-transition="right">
                Let's explore the food dictionary in the menu item!
            </p>
        </div>
        <!-- Slides End -->
<%--    </div>--%>
